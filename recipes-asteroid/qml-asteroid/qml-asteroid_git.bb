...
SRC_URI = "git://github.com/AsteroidOS/qml-asteroid.git;protocol=https;branch=master \
           file://0001-Drop-REQUIRED-from-ecm_find_qmlmodule-VirtualKeyboard.patch \
           file://0002-Add-AsteroidApp-unnamespaced-alias-for-cmake-compat.patch \
           file://0003-Add-FindMlite5-cmake-module.patch \
           "
SRCREV = "${AUTOREV}"
PR = "r1"
PV = "+git${SRCPV}"
